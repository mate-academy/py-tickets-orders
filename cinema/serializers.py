...
class MovieSessionListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MovieSession
        fields = ("id", "show_time", "movie_title", "cinema_hall_name", "cinema_hall_capacity", "tickets_available")
...
class MovieSessionDetailSerializer(serializers.ModelSerializer):
    ...
    def get_taken_places(self, obj):
        taken_places = Ticket.objects.filter(movie_session=obj).values("row", "seat")
        return list(taken_places)
