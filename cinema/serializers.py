...
class MovieSessionDetailSerializer(MovieSessionSerializer):
    ...
    taken_places = TicketShortSerializer(
        many=True,
        read_only=True,
        source="tickets"
    )
...
class OrderListSerializer(serializers.ModelSerializer):
    tickets = TicketsListSerializer(many=True, read_only=True)
